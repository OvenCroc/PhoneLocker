...
public final class SPUtils {
    ...
    private SPUtils(final String spName) {
        sp = App.Companion.getApp().getSharedPreferences(spName, Context.MODE_PRIVATE);
    }
    ...
    public static void spClear(String spName) {
        SharedPreferences sharedPreferences = App.Companion.getApp().getSharedPreferences(spName, Context.MODE_PRIVATE);
